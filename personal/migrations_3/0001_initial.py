...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('clientes', '0002_auto_20150928_0928'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_nacimiento', models.DateField(default=datetime.datetime(2015, 9, 28, 13, 28, 43, 755000, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horario_inicio', models.TimeField(default=datetime.datetime(2015, 9, 28, 13, 28, 43, 758000, tzinfo=utc))),
                ('horario_fin', models.TimeField(default=datetime.datetime(2015, 9, 28, 13, 28, 43, 758000, tzinfo=utc))),
            ],
        ),
        migrations.AddField(
            model_name='empleado',
