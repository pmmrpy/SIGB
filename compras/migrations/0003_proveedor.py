    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta_proveedor', models.DateTimeField(default=datetime.datetime(2016, 6, 1, 15, 52, 33, 171000, tzinfo=utc), help_text=b'La Fecha de Alta se asigna al momento de guardar los datos del Proveedor. No se requiere el ingreso de este dato.', verbose_name=b'Fecha de Alta')),
            ],
            options={
