...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('compras', '0211_auto_20160928_0742'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2016, 10, 1, 15, 14, 26, 447000, tzinfo=utc), help_text=b'Indique la fecha y hora en la que el proveedor debe entregar la Orden de Compra.', verbose_name=b'Fecha/hora de Entrega'),
        ),
        # migrations.AlterField(
